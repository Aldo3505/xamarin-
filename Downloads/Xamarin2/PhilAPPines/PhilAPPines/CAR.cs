...
namespace PhilAPPines
{
    ...
    public class CAR : Activity
    {
        ...
        {
            Intent PLACES = new Intent(this, typeof(CARPLACES));
            StartActivity(PLACES);
        }

        private void People_Click(object sender, EventArgs e)
        {
            Intent PPL = new Intent(this, typeof(CARPPL));
            StartActivity(PPL);
        }

        private void Food_Click(object sender, EventArgs e)
        {
            Intent FOOD = new Intent(this, typeof(CARFOOD));
            StartActivity(FOOD);
        }

        private void Info_Click(object sender, EventArgs e)
        {
            Intent INFO = new Intent(this, typeof(CARINFO));
            StartActivity(INFO);
        }
    }
}