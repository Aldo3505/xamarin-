...
{
    [Activity(Label = "CLINFO")]
    public class CLINFO : Activity
    {
        ImageButton Sun;
        TextView title, trivia1, trivia2, trivia3, trivia4, trivia5, trivia6, trivia7, trivia8;

        protected override void OnCreate(Bundle savedInstanceState)
        {
            base.OnCreate(savedInstanceState);

            SetContentView(Resource.Layout.CLUZONINFO);
