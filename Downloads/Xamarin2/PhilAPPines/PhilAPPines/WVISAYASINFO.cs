...
{
    [Activity(Label = "WVISAYASINFO")]
    public class WVISAYASINFO : Activity
    {
        ImageButton Sun;
        TextView title, trivia1, trivia2, trivia3, trivia4, trivia5, trivia6, trivia7, trivia8, trivia9, trivia10;

        protected override void OnCreate(Bundle savedInstanceState)
        {
            base.OnCreate(savedInstanceState);

            SetContentView(Resource.Layout.WVISAYASINFO);
