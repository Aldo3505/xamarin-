...
{
    [Activity(Label = "WVISAYASPLACES")]
    public class WVISAYASPLACES : Activity
    {
        ImageButton Sun;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            //assuming that CARPLACES has 2 places only
            SetContentView(Resource.Layout.WVISAYASPLACES);
